...
def click(value):
	if value==1:
		...
		options1=[("Place through Zipcode",1),("Zipcode through place",2),("Co-ordinates through place",3),("Place through co-ordinates",4),("Distance Between Places",5)]
		...
		def next1(val):
			if val==1:
				...
				def con():
					...
					my_label1=Label(frame1,text="Converted Amount= "+str(converter.convert(currfrom,currto,amt))+currto)
					my_label1.grid(row=0,column=0)
